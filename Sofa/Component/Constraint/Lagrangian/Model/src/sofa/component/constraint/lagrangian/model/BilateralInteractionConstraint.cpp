...
public:
    ...
    static void bwdInit(BilateralInteractionConstraint<T>& self) {
        ...
        const BilateralInteractionConstraint<T>::SubsetIndices& m1Indices = self.m1.getValue();
        const BilateralInteractionConstraint<T>::SubsetIndices& m2Indices = self.m2.getValue();
    ...
    {
        helper::WriteAccessor<Data<BilateralInteractionConstraint<T>::SubsetIndices > > wm1 = self.m1;
        helper::WriteAccessor<Data<BilateralInteractionConstraint<T>::SubsetIndices > > wm2 = self.m2;
