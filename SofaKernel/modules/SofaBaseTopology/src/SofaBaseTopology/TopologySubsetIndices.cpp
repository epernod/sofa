...
TopologySubsetIndices::TopologySubsetIndices(const typename sofa::core::topology::BaseTopologyData< helper::vector<Index> >::InitData& data)
    : sofa::component::topology::TopologySubsetData< core::topology::BaseMeshTopology::Point, helper::vector<Index> >(data)
{
